---
name: mmkc-tiktok-cut-skill
description: >
  用 JSON edit plan 和 FFmpeg 把 AI 视频、本地素材或口播素材剪成 9:16 TikTok/Reels/Shorts 成片。
  English: Render 9:16 TikTok, Reels, or Shorts videos from AI clips, local assets, or talking-head footage using JSON edit plans and FFmpeg.
---
